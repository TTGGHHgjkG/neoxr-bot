module.exports = (m, env) => {
   ...
   if (setting) {
      ...
      if (!('cover' in setting)) setting.cover = 'https://telegra.ph/file/71346e3e36e816e428739.png'
      if (!('link' in setting)) setting.link = 'https://chat.whatsapp.com/FabtqDKLoiUARBUt03bktE'
   } else {
      global.db.setting = {
         autodownload: true,
         debug: false,
         ...
         messageSent: 0,
         messageReceive: 0,
         cover: 'https://telegra.ph/file/71346e3e36e816e428739.png',
         link: 'https://chat.whatsapp.com/FabtqDKLoiUARBUt03bktE'
      }
   }
}